...
func _pressed():
	get_parent().get_parent().get_parent().get_node("MinigameDescription/Title").text="Beat Beast"
	...
	get_parent().get_parent().get_parent().get_node("PlayButton").selectedGameDir="res://MenuScenes/mainMenu.tscn"
